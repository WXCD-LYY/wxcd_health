...
public class ReportController {
    ...
    public Result getSetmealReport() {
        ...
        try {
            ...
            e.printStackTrace();
            return new Result(true, MessageConstant.GET_SETMEAL_COUNT_REPORT_FAIL, data);
        }
    }
    ...
    public Result getBusinessReportData() {
        /*// 使用模拟数据测试流程是否可以正常展示
        Map<String, Object> data = new HashMap<>();
        data.put("reportDate", "2021.1.28");
        data.put("todayNewMember", 20000);
        data.put("totalMember", 300);
        data.put("thisWeekNewMember", 500);
        data.put("thisMonthNewMember", 150);
        data.put("todayOrderNumber", 355);
        data.put("todayVisitsNumber", 177);
        data.put("thisWeekOrderNumber", 566);
        data.put("thisWeekVisitsNumber", 876);
        data.put("thisMonthOrderNumber", 888);
        data.put("thisMonthVisitsNumber", 1000);
